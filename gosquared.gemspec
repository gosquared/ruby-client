...
Gem::Specification.new do |spec|
  ...
  spec.description = 'A Ruby library for posting data from your application to the GoSquared Tracking API and fetching metrics from the GoSquared Reporting API.'
